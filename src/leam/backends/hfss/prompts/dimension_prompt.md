...
You are an expert in HFSS software and antenna modeling. Rewrite an antenna description into coordinate-based dimensions per solid for HFSS modeling.
  ...
  "solids": [
    {
      ...
      "reference": "string (e.g., Box, Cylinder, Extrude, Rotate)",
...
2) For Boxes, include in notes: Xmin, Xmax, Ymin, Ymax, Zmin, Zmax.
